...
use crate::home_assistant::HomeAssistantTool;
...
use crate::philips_hue::PhilipsHueTool;
...
use crate::sonos::SonosTool;
use crate::spotify::SpotifyTool;
...
tool_attribution!(HomeAssistantTool, ToolKind::Plugin);
...
tool_attribution!(PhilipsHueTool, ToolKind::Plugin);
...
tool_attribution!(SonosTool, ToolKind::Plugin);
tool_attribution!(SpotifyTool, ToolKind::Plugin);
